...
public class RunCalculateCarTravelTimes {
	...
	public static class CarTravelTimeCalculator implements Runnable {
		...
		public CarTravelTimeCalculator(ThreadCounter threadCounter, Network network, TripItemForOptimization trip) {
			this.threadCounter = threadCounter;
			this.networkCar = network;
			this.trip = trip;
		}
		public CarTravelTimeCalculator(ThreadCounter threadCounter, Network network, TripItemForOptimization trip, ArrayBlockingQueue<LeastCostPathCalculator> carRouters) {
			this.threadCounter = threadCounter;
			this.networkCar = network;
			this.trip = trip;
