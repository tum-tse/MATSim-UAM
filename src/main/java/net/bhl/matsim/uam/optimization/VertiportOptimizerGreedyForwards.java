   ...
   // sort the vertiport pair
    ...
    public static double calculateSelectionScore( List<Vertiport> vertiportCandidate,List<Integer> chosenVertiportID, List<TripItemForOptimization> deserializedTripItemForOptimizations) {
        ...
        for (TripItemForOptimization tripItemForOptimization : uamAvailableTrips) {
            ...
            Double [] modeProbability={tripItemForOptimization.uamProbability, tripItemForOptimization.carProbability, tripItemForOptimization.ptProbability};
            // Create a double list to store the generalized cost of each mode
            Double [] modeGeneralizedCost={tripItemForOptimization.UAMGeneralizedCost, tripItemForOptimization.carGeneralizedCost, tripItemForOptimization.ptGeneralizedCost};
            ...
            double generalizedCostOneTripAfter= tripItemForOptimization.carGeneralizedCost*modeSamples[0]+ tripItemForOptimization.ptGeneralizedCost*modeSamples[1]+ tripItemForOptimization.UAMGeneralizedCost*modeSamples[2];
