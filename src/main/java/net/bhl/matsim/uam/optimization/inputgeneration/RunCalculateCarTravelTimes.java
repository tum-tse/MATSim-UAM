package net.bhl.matsim.uam.optimization.inputgeneration;

import com.opencsv.CSVParser;
import net.bhl.matsim.uam.analysis.traveltimes.utils.*;
...
public class RunCalculateCarTravelTimes {
    ...
    private static boolean writeDescription = false;
    ...
    private static String formatHeader() {
        return String.join(String.valueOf(CSVParser.DEFAULT_SEPARATOR),
                new String[]{"id","origin_x", "origin_y", "destination_x", "destination_y",
